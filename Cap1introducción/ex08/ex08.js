...
console.log( a== b);
// en el operador && = Y, deben de cu7mplirse dos condiciones para que retorne true o verdadero.

// en este ehercicio, nose considera ciudadano a quien no tenga 18 años.

let pais, edad;
pasis = prompt( "ingrese su pais de procedencia:");
...
// solicitar el dia el mes y año, luegp verificar si los valores ingresados son numericos.
let day, month, year,

day = parseInt(prompt("digite el dia en numeros:"));
month= pareInt(prompt("digite el mes en numeros"));
year = paraInt(prompt("digite el año en numeros"));
